...
.hero h1 {font-size: 2.35rem; margin-bottom: 0.3rem;}
...
def logo_header() -> None:
    ...
    with left:
        st.markdown(
            f"""
            <div class="hero">
                <span class="badge">Research prototype • Market-ready interface</span>
                <h1>{APP_TITLE}</h1>
                <p>{TAGLINE}</p>
    ...
    with right:
        if LOGO_PATH.exists():
            ...
            st.caption("Add your file as `assets/company_logo.png`.")

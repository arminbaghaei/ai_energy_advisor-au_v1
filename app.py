...
def profile_screen() -> None:
    ...
    with st.form("profile_form"):
        st.info("This anonymous version does not collect names, email addresses, or contact details. If you choose to submit your results at the end, the system will assign a participant ID such as Participant 1 or Participant 2.")
        c1, c2 = st.columns(2)
        with c1:

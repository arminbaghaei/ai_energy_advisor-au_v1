...
def estimate_money_snapshot(monthly_bill: float, household_size: str, main_problem: str) -> dict:
    ...
    if annual_bill <= 0:
        ...
        waste_high = annual_bill * min(base_high, 0.30)
    return {
...
def money_screen() -> None:
    ...
    if submitted or "money_snapshot" in st.session_state:
        if submitted:
            ...
            st.session_state["money_snapshot"] = estimate_money_snapshot(monthly_bill, household_size, bill_problem)

...
.hotspot-visual-strip .visual-choice-grid {grid-template-columns:repeat(3,minmax(165px,1fr));}
.hotspot-visual-strip .visual-choice-card {min-height:108px;}
@media (max-width: 900px) {.visual-choice-grid {grid-template-columns:repeat(3,minmax(135px,1fr));}}
